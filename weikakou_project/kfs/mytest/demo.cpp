...
char s[64] = "rtsp://192.168.88.11:8554/live0.h264";
	...
	if(rtn == 5)
	{
        ...
        sprintf(nowtime,"%d-%d-%d %d:%d:%d", tm_now->tm_year+1900, tm_now->tm_mon+1, tm_now->tm_mday, tm_now->tm_hour, tm_now->tm_min, tm_now->tm_sec) ;
		 ...
		 curl_global_init(CURL_GLOBAL_ALL);
            ...
            sprintf(qingbao,"{\"time\":\"%s\",\"dev\":\"%s\",\"name\":\"%s\",\"channel\":\"%s\",\"vehicle\":{\"plate\":\"%s\",\"color\":\"%s\",\"brand\":\"%s\",\"type\":\"%s\"}}",nowtime,"110","杏坛农场","",plate,"","","");
...
//		curl_easy_setopt(easy_handle, CURLOPT_PROXY, "211.87.227.249:3128"); 
                ...
                curl_easy_setopt(easy_handle, CURLOPT_URL, "http://123.233.246.99:120/dqz1.php");
